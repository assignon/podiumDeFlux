<?php
 ...
 require "../vrijwilliger/site/models/login_model.php";
 $login = new login();
 $login->signin();
...
<html>
    <head>
      ...
      <link rel="stylesheet" href="../vrijwilliger/public/css/login.css"/>
    <!--  <link rel="stylesheet" href="../reachoutNL/public/css/font.css"/>-->
      <script src="../vrijwilliger/public/js/login.js"></script>
      <title>Login</title>
    </head>
    <body>
            ...
            <div class="loginPage">
              ...
              <div id="core">
                 ...
                 <div id="recoveryDataScreen">
                    ...
                    <img src="../vrijwilliger/public/media/images/delete.svg" alt="" id="closeRecoverForm">
